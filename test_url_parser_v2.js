...
function convertUrl(videoId) {
    ...
    if (videoId.includes('youtube.com') || videoId.includes('youtu.be')) {
        ...
        if (ytId) {
            // Clean the ID (remove trailing slashes and whitespace)
            ytId = ytId.replace(/\//g, '').trim();
...
const testCases = [
    { input: 'https://youtube.com/shorts/nyIxTKiPh9Q?si=flBNHmXXD2DdvB3G', expected: 'https://www.youtube.com/embed/nyIxTKiPh9Q?autoplay=1' },
    { input: 'https://youtube.com/shorts/nyIxTKiPh9Q/?si=flBNHmXXD2DdvB3G', expected: 'https://www.youtube.com/embed/nyIxTKiPh9Q?autoplay=1' }, // With trailing slash
    { input: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', expected: 'https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1' },
    { input: 'https://youtu.be/dQw4w9WgXcQ/', expected: 'https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1' } // Short link with trailing slash
];
